...
export const BatteryThresholdController = GObject.registerClass({
    ...
    _updateAutoDischarge() {
        ...
        // 2. Start Condition: Above End Threshold (on AC)
        if (batteryLevel > endThreshold && !this.forceDischargeEnabled) {
            console.log(`Unified Power Manager: Auto-discharge: Level ${batteryLevel}% > End ${endThreshold}%, enabling`);
