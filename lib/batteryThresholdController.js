...
export const BatteryThresholdController = GObject.registerClass(
    ...
    class BatteryThresholdController extends GObject.Object {
            ...
            return new Promise((resolve) => {
                ...
                this._upowerProxy = new upowerProxyWrapper(
                    ...
                    (proxy, error) => {
                        ...
                        if (error) {
                            debugError('Failed to create main UPower proxy:', error);
                        } else {
                ...
                this._proxy = new powerManagerProxy(
                    ...
                    (proxy, error) => {
                        ...
                        if (error) {
                            debugError('Failed to create UPower proxy:', error);
                        } else {
        ...
        get batteryHealth() {
            if (this._device) return this._device.getHealth();
        ...
        async setForceDischarge(enabled, isManual = true) {
            ...
            try {
                ...
                if (!this._destroyed) debugError('Error setting force discharge:', e.message);
                return false;
            }
        ...
        async refreshValues() {
            if (this._device) await this._device.refreshValues();
