...
export function findMatchingProfile(profiles, currentParams) {
    try {
        ...
        for (const profile of profiles) {
            ...
            } else if (specificity === bestSpecificity && hasSchedule) {
                // Tiebreaker: prefer the scheduled profile during its active window
                // (schedule activity was already verified at line 83)
                bestMatch = profile;
            }
        }
