...
const {findValidProgramInPath, runCommand, debugError} = Helper;
    ...
    class PowerProfileController extends GObject.Object {
        ...
        async initialize() {
            ...
            try {
                ...
                if (this._destroyed) return false;
                // D-Bus unavailable; fall through to CLI
            }
        ...
        async _refreshFromCli() {
            ...
            else if (stderr) debugError('powerprofilesctl get failed:', stderr.trim());
            ...
            if (listStatus === 0 && listStdout) {
                ...
                debugError('powerprofilesctl list failed:', listStderr.trim());
            }
        }
        ...
        async setProfile(profile) {
            ...
            if (this._proxy) {
                ...
                try {
                    ...
                    if (this._destroyed) return false;
                    // D-Bus assignment failed; fall through to CLI
                }
            }
            ...
            if (this._powerprofilesctlPath) {
                ...
                if (status === 0) {
                    ...
                    debugError('powerprofilesctl failed:', stderr.trim());
                }
            }
