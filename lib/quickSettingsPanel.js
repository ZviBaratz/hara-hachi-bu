...
class PowerManagerToggle extends QuickSettings.QuickMenuToggle {
    constructor(settings, extensionObject, stateManager) {
        ...
        if (this.accessible) {
            this.accessible.accessible_name = _('Hara Hachi Bu - Switch power modes, battery thresholds, and profiles');
        }
                ...
                try {
                    ...
                    if (!this._destroyed) {
                        if (success) {
                            ...
                            this._showInlineError(_('Failed to apply profile'));
                            this._updateUI();
                        }
                    }
                } finally {
    ...
    _getBatteryStatusText() {
        ...
        if (currentProfile) {
            ...
            primaryParts.push(_('No profile'));
        }
