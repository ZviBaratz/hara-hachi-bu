...
class PowerManagerToggle extends QuickSettings.QuickMenuToggle {
    ...
    _buildErrorSection() {
        ...
        if (this._stateManager.batteryNeedsHelper) {
            const item = new PopupMenu.PopupImageMenuItem(
                _('Battery Thresholds: Setup Required'),
    ...
    _addAutoManageSection() {
        ...
        this._pausedIndicator = new PopupMenu.PopupMenuItem(_('Auto-switching paused — you manually selected a profile or mode'));
    ...
    _updateBoostChargeState() {
        ...
        if (active) {
            ...
            this._boostChargeItem.label.text = (onBattery && !active)
