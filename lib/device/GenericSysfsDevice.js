...
export const GenericSysfsDevice = GObject.registerClass(
    ...
    class GenericSysfsDevice extends BaseDevice {
        /**
         * @param batteryPath - The full path to the battery sysfs directory (e.g., '/sys/class/power_supply/BAT0')
         */
         ...
         * @param batteryPath - e.g. '/sys/class/power_supply/BAT0'
         */
         ...
         * @param startValue - Start threshold (0-100), ignored if device has no start threshold
         * @param endValue - End threshold (0-100)
