...
export const GenericSysfsDevice = GObject.registerClass({
    ...
    constructor() {
        super();
        this.name = 'Generic Sysfs Device';
        this.ctlPath = null;
    ...
    static isSupported() {
        ...
        // We require both start and end thresholds for full support
        // Some devices might only have end threshold, but our UI expects both currently.
        return fileExists(BAT0_START_PATH) && fileExists(BAT0_END_PATH);
    }
