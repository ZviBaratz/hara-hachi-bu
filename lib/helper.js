 ...
 * @param name - Battery name (e.g. BAT0)
 * @returns
 */
 ...
 * @param value - Threshold percentage
 * @returns
 */
 ...
 * @param behaviour - Raw content of charge_behaviour file
 * @returns - True if force-discharge is currently active
 */
 ...
 * @param path - Absolute path to the file
 * @returns - Parsed integer or null if failed
 */
 ...
 * @param program - Program name (e.g., 'ls')
 * @returns - Absolute path to program or null if not found
 */
 ...
 * @param enableTimeout - Whether to enable timeout (default: true)
 ...
 * @private
 * @param argv - Command arguments
 * @param enableTimeout - Whether to enable timeout
 * @returns - [exitCode, stdout, stderr]
 */
 ...
 *
 * @param ctlPath - Path to helper script
 * @param command - Command string to pass to helper
 * @param args - Additional arguments for the helper
 * @returns - [exitCode, stdout, stderr]
 */
 ...
 *
 * @param sysfsPath - Path to /sys/class/power_supply
 * @param [isCancelled] - Optional callback returning true if caller is destroyed
 * @returns true if AC online, false if on battery, null if unknown
 */
 ...
 * @param iconFolder - Path to the extension's icon folder
