        ...
        try {
            ...
            await new Promise((resolve) => {
                ...
                this._proxyInitTimeout = GLib.timeout_add(GLib.PRIORITY_DEFAULT, 5000, () => {
                    ...
                    if (!resolved) {
                        resolved = true;
                        console.warn('Unified Power Manager: UPower proxy initialization timed out in ParameterDetector');
                        resolve();
                    }
                ...
                this._upowerProxy = new upowerProxyWrapper(
                    ...
                    (proxy, error) => {
                        ...
                        this._upowerProxy.connectObject('g-properties-changed', (proxy, changed) => {
                            if (this._destroyed) return;
