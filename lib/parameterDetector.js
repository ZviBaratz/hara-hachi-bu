...
const {debugError, debugWarn} = Helper;
...
export const ParameterDetector = GObject.registerClass(
    {
        GTypeName: 'HhbParameterDetector',
        Signals: {
    ...
    class ParameterDetector extends GObject.Object {
        ...
        _initializeDisplayMonitoring() {
            try {
                ...
                debugError('Failed to initialize display monitoring:', e);
            }
        }
            ...
            try {
                ...
                await new Promise((resolve) => {
                    ...
                    this._proxyInitTimeout = GLib.timeout_add(GLib.PRIORITY_DEFAULT, PROXY_INIT_TIMEOUT_MS, () => {
                        ...
                        if (!resolved) {
                            resolved = true;
                            debugWarn('UPower proxy initialization timed out in ParameterDetector');
                            resolve();
                        }
                ...
                debugError('Failed to initialize power source monitoring:', e);
            }
        }
        ...
        _updateDisplayState() {
            try {
                ...
                debugError('Error updating display state:', e);
                this._externalDisplayConnected = false;
            }
        }
